package ru.sstu.sharing.services.impl;

import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.security.core.Authentication;
import org.springframework.stereotype.Service;
import ru.sstu.sharing.dao.*;
...
import ru.sstu.sharing.services.MailService;
...
public class OrderServiceImpl implements OrderService {
    ...
    @Override
    public void addInBasket(Long id, Authentication authentication)
            throws UserDoesNotExist, ProductDoesNotExist {
    ...
    private Order getBasket(User buyer) {
        ...
        Optional<Order> orderOptional = this.orderRepository
                .findByBuyerAndStatus(buyer, basketStatus);
        Order order;
    ...
    private OrderProduct getOrderProduct(Order order, Product product) {
        Optional<OrderProduct> optionalOrderProduct = this.orderProductRepository
...
/*            int quantity = product.getQuantity() - orderProduct.getQuantity();
        ...
        mailService.sendOrderBuyer(order);
    ...
    @Override
    public void changeQuantity(Integer quantity, Long productId, Authentication authentication)
            throws
    ...
    private OrderProduct getOrderProduct(Product product, Authentication authentication) throws
        ...
        Optional<OrderProduct> optionalOrderProduct = this.orderProductRepository
                .findByStatusAndBuyerAndProduct(status, buyer, product);
